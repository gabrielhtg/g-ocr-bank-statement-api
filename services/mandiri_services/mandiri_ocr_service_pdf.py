...
def doOcrMandiriPdf (imageArray, app, isZip, isPdf, logger, username) :
    periodeLaporan = None
    nomorRekening = None
        ...
        for e in text_ :
            ...
            if page == 1 :
                if 'per' in text.lower() and ch < 0.3 * tinggiGambar :
                    ...
                    thbPeriodeLaporan = bb + int(0.022 * tinggiGambar)
            ...
            try :
                if 'description' in text.lower() and ch < 0.4 * tinggiGambar and currentRow == 0:
                    ...
                    thrTableCol1 = rb - int(0.22 * tinggiGambar)
                    thrTableCol2 = thrTableCol1 + int(0.087 * tinggiGambar)
                    thrTableCol3 = thrTableCol2 + int(0.183 * tinggiGambar)
                    thrTableCol4 = thrTableCol3 + int(0.116 * tinggiGambar)
                    thrTableCol5 = thrTableCol4 + int(0.084 * tinggiGambar)
                    thrTableCol6 = thrTableCol5 + int(0.088 * tinggiGambar)
